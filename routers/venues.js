...
const { Venue } = require("../utils/schema");
...
router.patch("/:id", validateApiKey, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.delete("/:id", validateApiKey, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
