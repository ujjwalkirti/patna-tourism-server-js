...
app.get("/get-api-key", ensureAuthenticated, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.get("/auth/google/callback", passport_1.default.authenticate("google"), (req, res) => {
    if (!req.user) {
        // Authentication failed, send JSON response with failure status
        return res.status(401).json({ message: "Authentication failed." });
    }
    // Successful authentication, send JSON response with success status
    res
        .status(200)
